...
> ⚠️ **Release status:** `v1.0.0-rc9` is a Release Candidate. Validate it in a staging environment before adopting it for production workloads; public APIs may still receive release-blocking corrections before `v1.0.0`.
...
```bash
go install github.com/NeftaliAcosta/springo/cmd/springo@v1.0.0-rc9
```
...
│   └── springo/               # Installable `springo` entrypoint (v1.0.0-rc9)
