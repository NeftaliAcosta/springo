...
var subdirs = []string{
	...
	"internal/infrastructure/output/persistence/data",
	"internal/infrastructure/output/persistence/mapper",
	"internal/infrastructure/output/persistence/request",
	"internal/infrastructure/output/persistence/response",
	"internal/infrastructure/output/rest/request",
	"internal/infrastructure/output/rest/response",
	"internal/infrastructure/output/rest/mapper",
...
func GenerateProject(config ProjectConfig) error {
	...
	fileMap := map[string]string{
		...
		"templates/user_entity.tmpl":             "internal/infrastructure/output/persistence/data/user_entity.go",
		"templates/user_persistence_mapper.tmpl": "internal/infrastructure/output/persistence/mapper/user_persistence_mapper.go",
